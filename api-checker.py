...
class Window(Frame):
	...
	def init_window(self):
		...
		self.sb2.grid(row=1,column=1, ipady=167, sticky=N)
		self.lb_tasksb.configure(yscrollcommand=self.sb2.set)
		self.sb2.configure(command=self.lb_tasksb.yview)

		# TEXT HEADER
		labelT = Label(rf, text="APPLICATION/JSON", font=verd12,  fg='blue').pack(pady=(5,15))
